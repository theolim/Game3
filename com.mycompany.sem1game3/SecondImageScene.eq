...
public class SecondImageScene : SEScene {
	...
	public void initialize(SEResourceCache rsc) {
		...
		rsc.prepare_image("mylagiacrus","img2", get_scene_width(),get_scene_height());
		...
		image1text.set_text("Captain America");
		image3text.set_text("Spiderman");
		image4text.set_text("Star Lord");
